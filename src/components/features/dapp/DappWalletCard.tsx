      ...
      <div className="relative p-4 flex flex-col justify-between h-full">
        <div className="flex items-start justify-between mb-4">
          ...
          <button
            ...
            disabled={isDeleting}
            className="text-zinc-600 hover:text-red-500 p-1 rounded hover:bg-red-500/10 transition-all opacity-0 group-hover:opacity-100 disabled:opacity-100 disabled:cursor-not-allowed"
            title="Delete Wallet"
          >
            {isDeleting ? (
              <svg
