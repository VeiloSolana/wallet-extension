...
const slides = [
  {
    ...
    description: "The first wallet that makes privacy on Solana simple, powerful, and automatic.",
    icon: (
  ...
  },
  {
    ...
    description: "We split your funds across multiple hidden wallets. You see one balance; the blockchain sees unconnected noise.",
    icon: (
      <svg className="w-24 h-24 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: "Your SOL enters a private pool. Once inside, your financial history becomes impossible to trace.",
    icon: (
      <svg className="w-24 h-24 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: "Every time you receive funds, we generate a brand new address. Your digital footprint remains fragmented.",
    icon: (
      <svg className="w-24 h-24 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: "Connect to apps using isolated wallets. Keep your main savings completely invisible to the sites you visit.",
    icon: (
      <svg className="w-24 h-24 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export const OnboardingWalkthrough = ({ onComplete, onClose }: OnboardingWalkthroughProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 pt-6 space-y-4">
        ...
        <button 
          onClick={onClose}
          className="absolute top-6 right-4 text-zinc-400 hover:text-white transition-colors"
        >
      ...
      <div className="p-8 flex items-center justify-between mt-auto">
        ...
        <button
          onClick={handleNext}
          className="bg-white text-black font-bold py-3 px-8 rounded-lg hover:bg-white/90 transition-all active:scale-95"
        >
