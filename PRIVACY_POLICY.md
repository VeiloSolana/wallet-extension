...
| Privacy keys              | ✅ Encrypted with your password     |
...
| What happens               | What we send                   | Why                                                               |
| -------------------------- | ------------------------------ | ----------------------------------------------------------------- |
| Fetching privacy pool data | Which network (mainnet/devnet) | To build the cryptographic proofs needed for private transactions |
...
Veilo is open source. You can read our code and verify every claim in this policy yourself.
